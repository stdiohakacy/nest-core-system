...
export class Initial1691859160142 implements MigrationInterface {
    name = 'Initial1691859160142';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "user_conversations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), "deletedAt" TIMESTAMP, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "userId" uuid NOT NULL, "conversationId" uuid NOT NULL, "name" character varying NOT NULL, "lastMessage" character varying NOT NULL, "lastTime" TIMESTAMP NOT NULL, CONSTRAINT "PK_24d9be3db028d13c70b445e9e33" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "conversations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), "deletedAt" TIMESTAMP, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, CONSTRAINT "PK_ee34f4f7ced4ec8681f26bf04ef" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "user_conversations" ADD CONSTRAINT "FK_dac4f29d9f3edb818ec8e34d461" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "user_conversations" ADD CONSTRAINT "FK_e26bf5aa0c0174225e6e09fb521" FOREIGN KEY ("conversationId") REFERENCES "conversations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "messages" DROP CONSTRAINT "FK_3096fc70fe5dcc8d516972f17ba"`
        );
        await queryRunner.query(
            `ALTER TABLE "user_conversations" DROP CONSTRAINT "FK_e26bf5aa0c0174225e6e09fb521"`
        );
        await queryRunner.query(
            `ALTER TABLE "user_conversations" DROP CONSTRAINT "FK_dac4f29d9f3edb818ec8e34d461"`
        );
        await queryRunner.query(
